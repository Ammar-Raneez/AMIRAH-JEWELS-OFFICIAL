...
function CheckOutPage() {
	...
	return (
		<div className="checkoutPage">
			<h2>Check Out</h2>
			<ValidatorForm onSubmit={proceedCheckout} ref={formRef} style={{ width: '100%' }} className="registerPage__form">
				<TextValidator
					style={{ width: '93%' }}
					type="text"
					label="First Name"
				...
				<div className="checkout__payment">
					<FormControl component="fieldset" style={{ width: '93%' }}>
						...
						>
							...
							<FormControlLabel value="masterCard" style={{ color: 'grey' }} control={<Radio />} label="MASTER CARD" />
						</RadioGroup>
					</FormControl>
				</div>
